...
<section onclick="closeSideMenu()" id="background_body">
    ...
    <section>
        ...
        <div class="container">
            ...
            <div class="Rectangle-20_prices">

                <div>
                    <div class="Forma-1_prices">€</div>
                    <span class="hr">
    ...
    <!-- Include Cleaning  -->
    <section class="include_cleaning">

        <p class="include_heading">
    ...
    <section class="extra_service">
        ...
        <h1 class="faq_title">Extra services</h1>
        ...
        <div class="container-fluid">
            <div class="flex-container flex-container-center">
                <div class="why_helperland_prices_box">
                    <p class="helperland_prices_heading">
                        Experienced and vetted professionals
                    </p>

                    <p class="helperland_prices_contain">
                ...
                <div class="why_helperland_prices_box">
                    <p class="helperland_prices_heading2">
                        Every cleaning is insured
                    </p>

                    <p class="helperland_prices_contain2">
