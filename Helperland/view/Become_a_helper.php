                ...
                <form onsubmit="return checkPassword(this)" method="POST" action="<?php echo "$base_url?function=insertaccountdetails"  ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group form">
                            ...
                            <input type="text" class="form-control" id="phone_no" placeholder="Phone Number" name="phone_no" required maxlength="10" pattern="[7-9]{1}[0-9]{9}" title="Enter valid 10 digit number" required>
                        </div>
