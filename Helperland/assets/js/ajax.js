    ...
    $.ajax({
      ...
      success: function (response) {
        if (response == 1) {
          ...
          $('#postalerror').html(
            'We are not providing service in this area. Well notify you if any helper would start working near your area.'
          );
        } else {
          postalvalidation();
...
function loaddashboard(offset, limit) {
  $.ajax({
    // type: "method",
    url:
      'http://localhost/helperland/index.php?function=fetchcurrentservicerequest&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
...
$('#reschudele_update').click(function () {
  ...
  $('#reschudele_date_error').css('display', 'none');
  $('#reschudele_error').css('display', 'none');
  ...
  if (checkdate > currentdate) {
    ...
    $('#reschdule_spinner').css('display', 'none');
    $('#reschudele_date_error').css('display', 'block');
  }
});
...
function dashboardmodal(servicerequestid) {
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#dashboard_serviceid').html(
        'Service Id: ' + servicedetails['ServiceId']
      );
      $('#servicedetailsdatetime').html(
        servicedetails['date'] +
          ' ' +
      ...
      $('#servicedetails_duration').html(
        'Duration: ' + servicedetails['duration']
      );

      $('.amount_paid').html(
        '&nbsp; &nbsp; &nbsp;' + servicedetails['TotalCost'] + '€'
      );

      $('#servicedetails_comments').html(
        'Comment: ' + servicedetails['Comments']
      );

      if (servicedetails['HasPets'] == 0) {
        $('#servicedetails_pets').html(
          "<img  src='assets/images/not-included.png' style='width: 20px;height: 20px;'>  I don't have pets at home."
        );
      } else {
        $('#servicedetails_pets').html(
          "<img  src='assets/images/included.png' style='width: 20px;height: 20px;'> I have pets at home."
        );
      }
      ...
      $('#dashboard_customername').html(
        'Customer Name: ' + servicedetails['customername']
      );
...
function loadserviceHistory(offset, limit) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=fetchServiceHistory&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
  ...
  if (serviceproviderid != undefined) {
    $.ajax({
      ...
      success: function (response) {
        ...
        $('#' + ratings_id_arr[0] + '-ratings').rateYo(
          'option',
          'rating',
          ratings_id_arr[1]
        );
...
function setting_set_details_sp() {
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#avatar_selected').attr(
        'src',
        'assets/images/' + userdetails['UserProfilePicture']
      );
...
function totalentries_NewService_SP(pets) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=TotalEntriesNewServiceRequest&parameter=' +
      pets,
    success: function (response) {
...
function loadNewServiceRequest_SP(offset, limit, pets) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=loadServiceRequest_SP&parameter=' +
      offset +
      '-' +
      limit +
      '-' +
...
function loadUpcomingService(offset, limit) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=loadUpcomingService_SP&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
...
function loadServiceHistory_Sp(offset, limit) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=loadServiceHistory_SP&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
...
function Accept_Service(serviceproviderid) {
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#customer_address_accept').html(
        'Service Address: ' + details['customer_address']
      );
...
function SetUpcomingServiceModal(servicerequestid) {
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#address_us').html(
        'Service Address: ' + serviceDetails['customer_address']
      );
      ...
      $('.serviceRequestId_us').attr(
        'id',
        serviceDetails['serviceRequestId'] + '_serviceRequestId-us'
      );
    },
  });
}
...
function loadBlockedCustomer_SP(offset, limit) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=GetBlockedCustomerlist&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
...
function loadBlockedCustomer(offset, limit) {
  $.ajax({
    url:
      'http://localhost/helperland/index.php?function=GetBlockedCustomerlist_C&parameter=' +
      offset +
      '-' +
      limit,
    success: function (response) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $('.rating_value_Sp').each(function () {
        ...
        $('#' + serviceRequestId + '-ratingSp').rateYo(
          'option',
          'rating',
          rating_val
        );
